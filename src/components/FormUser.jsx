  ...
  return (
    <form className="form" onSubmit={handleSubmit(submit)}>
      ...
      <label className="form__label">
        ...
        <input className="form__field" {...register('email')} type="email" placeholder="example@gmail.com"/>
      </label>
      <label className="form__label">
      ...
      <label className="form__label">
        ...
        <input className="form__field" {...register('first_name')} type="text" placeholder="Name" />
      </label>
      <label className="form__label">
